...
<div class="row m-t">
    <div class="col-lg-9 col-lg-offset-2 m-t">
        <dl class="dl-horizontal">
            ...
            <dt>联系电话</dt>
            <dd><?=$info['mobile']?UtilService::encode($info['mobile']):'';?></dd>
            <dt>地址</dt>
            <dd><?=$info['address']?UtilService::encode($info['address']):'';?></dd>
            <dt>品牌介绍</dt>
            <dd><?=$info['description']?UtilService::encode($info['description']):'';?></dd>
            <dd>
